...
import type { Job, Issue, Site } from "@/lib/types";
...
export function SupervisorDashboardClient({ data }: { data: DashboardData }) {
  const {
    jobsList,
    issuesList,
    overdueList,
  ...
  const getSite = (siteId: string) => siteMap[siteId];
    ...
    <div className="space-y-8">
      ...
      <StatsGrid columns={4}>
        ...
        <StatCard
          ...
          icon={CheckCircle2}
          description={`${completedCount} of ${jobsList.length} completed`}
          variant="success"
            ...
            {overdueList.map((job) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-semibold">{getSite(job.site_id)?.name ?? "Site"}</p>
